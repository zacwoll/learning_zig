...
pub fn main() void {
    // This variable n is mutated, so const is a bad modifier for it
    // const n: u8 = 50;
    var n: u8 = 50;
    n = n + 5;

    // This u8 isn't big enough to hold 314159, min size u19
    // explanation: 2^18 = 262144 <-value-> 2^19 = 524288
    // const pi: u8 = 314159
    const pi: u19 = 314159;
