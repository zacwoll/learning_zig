...
pub fn main() void {
	...
	// I decided to demonstrate my knowledge of the type inference system working both ways!
...
//
// I actually thought this wouldn't work right, I thought the while would fail
