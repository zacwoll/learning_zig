...
pub fn main() void {
    ...
    x = 3;
	// 'i' is the xth index of letters
	// assign the character 'i' the 1 index of lang
    // lang[???] = letters[x];
	lang[1] = letters[x];

	// 'g' is the th index of letters
	// assign the character 'g' to the 2nd index of lang using x
    x = 5;
    lang[2] = letters[x];
