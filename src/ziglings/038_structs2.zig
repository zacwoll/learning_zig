...
pub fn main() void {
	...
	// A: Zump initializes the other Character-sized memory block that was allocated
	// If you accessed the memory block before initializing it, you would get undefined
	// the character array was set to undefined by default
